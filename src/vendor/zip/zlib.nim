...
proc deflate*(strm: var ZStream, flush: cint): cint{.cdecl,
    importc: "deflate".}
proc deflateEnd*(strm: var ZStream): cint{.cdecl,
    importc: "deflateEnd".}
proc inflate*(strm: var ZStream, flush: cint): cint{.cdecl,
    importc: "inflate".}
proc inflateEnd*(strm: var ZStream): cint{.cdecl,
    importc: "inflateEnd".}
proc deflateSetDictionary*(strm: var ZStream, dictionary: Pbytef,
                           dictLength: Uint): cint{.cdecl,
    importc: "deflateSetDictionary".}
proc deflateCopy*(dest, source: var ZStream): cint{.cdecl,
    importc: "deflateCopy".}
proc deflateReset*(strm: var ZStream): cint{.cdecl,
...
proc inflateGetDictionary*(strm: var ZStream, dictionary: Pbytef,
                           dictLength: ptr Uint): cint{.cdecl,
    importc: "inflateGetDictionary".}
proc inflateSync*(strm: var ZStream): cint{.cdecl,
    importc: "inflateSync".}
proc inflateCopy*(dest, source: var ZStream): cint{.cdecl,
    importc: "inflateCopy".}
proc inflateReset*(strm: var ZStream): cint{.cdecl,
    importc: "inflateReset".}
proc inflateReset2*(strm: var ZStream, windowBits: cint): cint{.cdecl,
    importc: "inflateReset2".}
proc inflatePrime*(strm: var ZStream, bits: cint, value: cint): cint{.cdecl,
    importc: "inflatePrime".}
proc inflateMark*(strm: var ZStream): cint{.cdecl,
    importc: "inflateMark".}
proc inflateGetHeader*(strm: var ZStream, head: ptr GZHeader): cint{.cdecl,
    importc: "inflateGetHeader".}
proc zlibCompileFlags*(): Ulong{.cdecl,
    importc: "zlibCompileFlags".}
proc compress*(dest: Pbytef, destLen: Pulongf, source: Pbytef, sourceLen: Ulong): cint{.
    cdecl, importc: "compress".}
...
proc gzopen*(path: cstring, mode: cstring): GzFile{.cdecl,
    importc: "gzopen".}
proc gzdopen*(fd: cint, mode: cstring): GzFile{.cdecl,
    importc: "gzdopen".}
proc gzsetparams*(thefile: GzFile, level: cint, strategy: cint): cint{.cdecl,
    importc: "gzsetparams".}
proc gzread*(thefile: GzFile, buf: pointer, length: cuint): cint{.cdecl,
    importc: "gzread".}
proc gzwrite*(thefile: GzFile, buf: pointer, length: cuint): cint{.cdecl,
    importc: "gzwrite".}
proc gzprintf*(thefile: GzFile, format: Pbytef): cint{.varargs, cdecl,
    importc: "gzprintf".}
proc gzputs*(thefile: GzFile, s: Pbytef): cint{.cdecl,
    importc: "gzputs".}
proc gzgets*(thefile: GzFile, buf: Pbytef, length: cint): Pbytef{.cdecl,
    importc: "gzgets".}
proc gzputc*(thefile: GzFile, c: cint): cint {.cdecl,
    importc: "gzputc".}
proc gzgetc*(thefile: GzFile): cint {.cdecl, importc: "gzgetc".}
proc gzungetc*(c: cint; thefile: GzFile): cint {.cdecl, importc: "gzungetc".}
proc gzflush*(thefile: GzFile, flush: cint): cint{.cdecl,
    importc: "gzflush".}
proc gzseek*(thefile: GzFile, offset: ZOffT, whence: cint): ZOffT{.cdecl,
    importc: "gzseek".}
proc gzrewind*(thefile: GzFile): cint{.cdecl, importc: "gzrewind".}
proc gztell*(thefile: GzFile): ZOffT{.cdecl, importc: "gztell".}
proc gzeof*(thefile: GzFile): int {.cdecl, importc: "gzeof".}
proc gzclose*(thefile: GzFile): cint{.cdecl, importc: "gzclose".}
proc gzerror*(thefile: GzFile, errnum: var cint): Pbytef{.cdecl,
    importc: "gzerror".}
...
proc crc32*(crc: Ulong, buf: Pbytef, length: Uint): Ulong{.cdecl,
    importc: "crc32".}
proc deflateInitu*(strm: var ZStream, level: cint, version: cstring,
                   streamSize: cint): cint{.cdecl,
...
proc deflateInit2u*(strm: var ZStream, level: cint, `method`: cint,
                    windowBits: cint, memLevel: cint, strategy: cint,
                    version: cstring, streamSize: cint): cint {.cdecl,
...
proc zError*(err: cint): cstring{.cdecl, importc: "zError".}
proc inflateSyncPoint*(z: PZstream): cint{.cdecl,
...
proc compress*(sourceBuf: cstring; sourceLen: int; level=Z_DEFAULT_COMPRESSION; stream=GZIP_STREAM): string =
  ...
  var status = deflateInit2(z, level.cint, Z_DEFLATED.cint,
                               windowBits.cint, Z_MEM_LEVEL.cint,
...
proc uncompress*(sourceBuf: cstring, sourceLen: Natural; stream=DETECT_STREAM): string =
  ...
  while true:
    ...
    if (status == Z_STREAM_END):
      ...
      if z.availIn != 0:
        sbytes = sourceLen - z.availIn.Natural # add consumed bytes
